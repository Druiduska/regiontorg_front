async function login_jwt(s_url, s_login, s_password){
...
async function register_jwt(s_url, s_username, s_email,  s_login, s_password) {
  let formData = new FormData();
...
async function logout__jwt(s_url, token_type, access_token){
  let formData = new FormData();
...
async function refresh_jwt(s_url, token_type, access_token){
  let formData = new FormData();
...
async function get_me_jwt(s_url, token_type, access_token){  
  let formData = new FormData();
